...
const findAllDrivers = (findAllDriversUsecase) => async (req,res) => {
  try {
    let query = { ...req.body.query || {} };
    let options = { ...req.body.options || {} };
    let result = await findAllDriversUsecase({
      query,
      options,
...
const getDrivers = (getDriversUsecase) => async (req,res) =>{
  try {
    if (!req.params.id){
...
const getDriversCount = (getDriversCountUsecase) => async (req,res) => {
  try {
    ...
    let result = await getDriversCountUsecase({ where },req,res);  
    return responseHandler(res,result);
  } catch (error){
    return responseHandler(res,response.internalServerError({ message:error.message }));
  }
...
const updateDrivers = (updateDriversUsecase) => async (req,res) =>{
  try {
    if (!req.params.id){
...
const bulkUpdateDrivers = (bulkUpdateDriversUsecase) => async (req,res) => {
  try {
...
const partialUpdateDrivers = (partialUpdateDriversUsecase) => async (req,res) => {
  try {
    if (!req.params.id){
      return responseHandler(res,response.badRequest({ message : 'Insufficient request parameters! id is required.' }));
    }
...
const softDeleteDrivers = (softDeleteDriversUsecase) => async (req,res) => {
  try {
    if (!req.params.id){
      return responseHandler(res,response.badRequest({ message : 'Insufficient request parameters! id is required.' }));
    }
...
const deleteDrivers = (deleteDriversUsecase) => async (req,res) => {
  try {
    if (!req.params.id){
      return responseHandler(res,response.badRequest({ message : 'Insufficient request parameters! id is required.' }));
    }
    let query = { _id: req.params.id };
    let result = await deleteDriversUsecase({
      query,
      isWarning:req.body.isWarning || false
    },req,res);
    return responseHandler(res,result);
...
const deleteManyDrivers = (deleteManyDriversUsecase) => async (req,res) => {
  try {
    ...
    let result = await deleteManyDriversUsecase({
      query,
      isWarning:req.body.isWarning || false
    },req,res);
    return responseHandler(res,result);
...
const softDeleteManyDrivers = (softDeleteManyDriversUsecase) => async (req,res) => {
  try {
    if (!req.body || !req.body.ids){
      return responseHandler(res,response.badRequest({ message : 'Insufficient request parameters! id is required.' }));
    }
