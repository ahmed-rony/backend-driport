...
const createValidation = require("../../../../validation")(
  reportsSchema.createSchema
);
const updateValidation = require("../../../../validation")(
  reportsSchema.updateSchema
);
const filterValidation = require("../../../../validation")(
  reportsSchema.filterValidationSchema
);
const findAllReportsUsecase =
  require("../../../../use-case/reports/findAllReports")({
    reportsDb,
    filterValidation,
  });
const getReportsCountUsecase =
  require("../../../../use-case/reports/getReportsCount")({
    reportsDb,
    filterValidation,
  });
...
const getReportsCount = reportsController.getReportsCount(
  getReportsCountUsecase
);
